...
internal static class HierarchyMemberHelpers
{
    ...
    internal static void RemoveField(TrackedEdits edits, Document document, TypeDeclarationSyntax type, FieldDeclarationSyntax field, VariableDeclaratorSyntax variable)
    {
...
/// </summary>
internal sealed class TrackedEdits
{
    ...
    public TrackedEdits(Solution solution) => _solution = solution;
