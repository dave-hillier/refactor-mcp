    ...
    internal class UnusedMembersWalker : CSharpSyntaxWalker
    {
        ...
        public override void VisitInvocationExpression(InvocationExpressionSyntax node)
        {
            ...
            var name = node.Expression switch
            {
                ...
                MemberAccessExpressionSyntax { Expression: ThisExpressionSyntax or BaseExpressionSyntax } ma
                    when ma.Name is IdentifierNameSyntax named => named.Identifier.ValueText,
                _ => null
            };
        ...
        private void AnalyzeSingleFile()
        {
            ...
            {
                // _fieldRefs counts identifier names, and a field's declaration is
